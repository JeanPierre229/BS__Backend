          ...
          <div class="row my-1">
            ...
            <div class="col text-end">
              <p class="font-weight-bolder">
                Allez à la rencontre de nos professionnels <br> et découvrez nos formations
              </p>
              <button class="btn bg-gradient-info">Découvrir</button>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="card-body px-0 pt-0 pb-2">
                <div class="table-responsive p-0">
                  <table class="table align-items-center mb-0">
                    <thead>
                      <tr>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Identite</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Fonction</th>
                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Statut</th>
                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Dâte d'arrivée</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div>
                              <img src="../assets/img/team-3.jpg" class="avatar avatar-sm me-3" alt="Utilisateur2">
                            </div>
                            <div class="d-flex flex-column justify-content-center">
                        ...
                        <td class="align-middle text-center text-sm">
                          <span class="badge badge-sm bg-gradient-secondary">Déconnecté</span>
                        </td>
                        <td class="align-middle text-center">
